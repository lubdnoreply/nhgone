    ...
    <div className="min-h-full flex bg-slate-950 text-white w-full">
      <aside className="w-64 border-r border-white/10 p-6 flex flex-col gap-8 hidden md:flex shrink-0">
        ...
        <nav className="flex flex-col gap-2">
          <Link href="/" className={`px-4 py-2 hover:bg-white/5 rounded-lg transition-colors ${pathname === "/" ? "text-blue-400 font-medium bg-white/5" : "text-slate-400 hover:text-white"}`}>Dashboard</Link>
