  ...
  return (
    <div className="p-8 bg-white min-h-screen text-slate-900">
      <header className="mb-10">
        <h1 className="text-3xl font-extrabold tracking-tight mb-2">Email SMTP</h1>
        <p className="text-slate-500">Configure email server settings for system notifications</p>
      </header>
